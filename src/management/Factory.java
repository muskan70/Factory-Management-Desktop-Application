...
public class Factory {
	    ...
	    {
	    	frame=new JFrame("FACTORY MANAGEMENT SOFTWARE ");
	    	frame.setBounds(100,100,500, 300);
			Image icon=Toolkit.getDefaultToolkit().getImage("C:\\Users\\Muskan Mangla\\eclipse-workspace\\factory management software\\src\\money.png");
	        ...
	        l=new JLabel("Factory Management");
	        l.setBounds(90,20,400,40);
